...
void createObjects()
{
	...
	// tree
	const char* treeFileName = "../CGCommon/meshes/Tree/tree03.obj";
	vector<objl::Mesh> treemeshes = loadMeshes(treeFileName);
	tree = loadObjObject(treemeshes[0], true, treeVAO, false, vec3(-0.75f, -0.25f, 0.0f), vec3(1.0f, 1.0f, 1.0f), vec3(0.139f, 0.69f, 0.19f), 0.0f, NULL);
...
void leafParticlesStart() {
	...
	for (int i = 0; i < newparticles; i++) {
		...
		leafParticlesContainer[particleIndex].life = 5.0f; // This particle will live n seconds.
	...
	glm::vec3 leavesPos(-4.2f, 5.0f, 6.0f);
	//root camera
